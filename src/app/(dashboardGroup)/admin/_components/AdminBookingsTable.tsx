...
import { StatusBadge, BadgeVariant } from "@/components/share/status-badge";
...
export default function AdminBookingsTable({
    ...
    meta: initialMeta = { page: 1, limit: 5, total: 0 },
    ...
    const updateQueryParams = (key: string, value: string) => {
        ...
        params.set("page", "1"); // Filter বা Search পরিবর্তন হলে পেজ ১ এ রিসেট হবে
    ...
    return (
        <DataTable
            ...
            enableClientSearch={false} // Server-side search & pagination activated
            filterElement={
            ...
            pagination={{
                page: activeMeta.page || page,
                limit: activeMeta.limit || limit,
